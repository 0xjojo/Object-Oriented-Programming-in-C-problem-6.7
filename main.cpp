...
class angle  {
    private :
        ...
        char y ;
    public :
         angle () : degree (18) , minute (13.14) , direction ('E')
            { }
        void display_myangle () {
            cout << "The angle is:" << degree << x << minute << dummy_mark <<  direction ;
              }



        void get_angle (){
            cout << "\nEnter angle in format 179°59.9’ E :" << endl ;
        ...
        void display_angle (){
            cout << "The angle is:\n" << degree << x << minute << dummy_mark <<  direction ;
...
>>>>>>> 25f0f50fa0295cfefb69cc5d1800b6569a5eec69
